...
Route::get('/uploadavatar', function () {
...
Route::prefix('admin')->group(function() {
    ...
    Route::get('/choose-photo','AdminController@uploadPhotoForm')->name('photo.upload.form');
    Route::post('/upload-photo','AdminController@uploadPhoto')->name('photo.upload');
});
...
Route::group(['prefix'=>'/user', 'as'=>'user.', 'middleware'=>'auth'], function () {
    ...
    Route::get('/choose-photo','UserController@uploadPhotoForm')->name('photo.upload.form');
    Route::post('/upload-photo','UserController@uploadPhoto')->name('photo.upload');
